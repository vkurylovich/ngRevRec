package com.ecb.revrecapp.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "revrecapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "revrecapp API";

        private String description = "revrecapp API documentation";
    ...
    public static class Metrics {
        ...
        public static class Graphite {
            ...
            private String prefix = "revrecapp";
